...
class UserConfirmDlg extends Component {
	constructor (props) {
		super (props)
		...
		return (
			    <div>
			      <Modal isOpen={this.props.open} toggle={this.handleCancel} className='ConfirmDlg'>
			        <ModalHeader toggle={this.handleCancel}>Confirm Delete User</ModalHeader>
			        <ModalBody>
			          Confirm delete User!!!<br/>
